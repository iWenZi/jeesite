...
<%@page import="com.uns.paysys.common.web.Servlets"%>
<%@page import="com.uns.paysys.common.utils.Exceptions"%>
<%@page import="com.uns.paysys.common.utils.StringUtils"%>
...
<body>
<%if(StringUtils.toHtml(ex.getMessage()).indexOf("其它地方登录")<0) {%>
	...
	<%} %>
	<%if(StringUtils.toHtml(ex.getMessage()).indexOf("其它地方登录")>0) {%>
		<div class="page-header"><h1>您已被踢下线，请重新登录.</h1></div>
	<%} %>
</body>
</html>
<%
