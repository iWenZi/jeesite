...
<head>
	<title><sitemesh:title/> -- 强制修改</title>
...
<body>
	...
	<script type="text/javascript">//<!-- 无框架时，左上角显示菜单图标按钮。
		if(!(self.frameElement && self.frameElement.tagName=="IFRAME")){
			$("body").prepend("<span id=\"btnMenu\" class=\"icon-home\" style=\"cursor:pointer;float:right;margin:10px;\">转到主页</span><div id=\"menuContent\"></div>");
