...
<%-- <body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/user/list">推广商列表</a></li>
		<shiro:hasPermission name="merc:spreadMerchant:edit"><li><a href="${ctx}/merc/spreadMerchant/form">推广商添加</a></li></shiro:hasPermission>
	</ul>
