		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<%-- <li>
						<a href="<%=com.uns.paysys.modules.sys.utils.ParamPlatfrom.JS_URL %>&name=${fns:getUser().loginName}&pwd=${fns:getUser().clearPwd}" target="_blank" title="结算后台">结算</a>
					</li>
					<li style="padding-right:50px;">
						<a href="<%=com.uns.paysys.modules.sys.utils.ParamPlatfrom.YY_URL %>&name=${fns:getUser().loginName}&pwd=${fns:getUser().clearPwd}" target="_blank" title="运营后台">运营</a>
					</li> --%>
					<li style="padding-right:10px;">
						<a>
							<c:if test="${fns:getUser().leaveInfo == null}">您没有预留信息</c:if>
							<c:if test="${fns:getUser().leaveInfo != null}">您的预留信息是：${fns:getUser().leaveInfo}  </c:if>
						</a>
					</li>
