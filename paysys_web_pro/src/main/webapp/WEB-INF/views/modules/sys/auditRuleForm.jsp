	...
	<div class="control-group">
		...
		<table id="contentTable" class="table table-striped table-bordered table-condensed">
			...
			<tbody>
				...
				<c:forEach items="${auditRule.stepList }" var="step">
					<tr>
						<td>1</td>
						<td><form:input path="step.name" htmlEscape="false" maxlength="50" class="required" />
							<span class="help-inline"><font color="red">*</font> </span></td>
						<td><form:select path="step.auditGroupId" class="input-large required" multiple="false">
								<form:option value="" label="请选择" />
								<form:options items="${fns:getAuditGroupList()}" itemLabel="name" itemValue="id" htmlEscape="false" />
							</form:select> <span class="help-inline"><font color="red">*</font> </span></td>
