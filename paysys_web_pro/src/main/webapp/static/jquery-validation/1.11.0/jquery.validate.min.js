...
jQuery.validator.addMethod("ads1", function(b, a) {
	return this.optional(a) || /^[\u4e00-\u9fa5][A-Za-z]{1,50}$/.test(b)
}, "联系地址只能为1-50个汉字");
jQuery.validator.addMethod("userName", function(b, a) {
...
jQuery.validator.addMethod("ads", function(c, b) {
	var a = /^[\u4e00-\u9fa5-A-Za-z0-9\s*]{1,50}$/;
	return this.optional(b) || (a.test(c))
},  "联系地址只能为1-50个长度字符！");

jQuery.validator.addMethod("licenceNo", function(c, b) {
	var a =/^[A-Za-z0-9]{1,18}$/;
	return this.optional(b) || (a.test(c))
}, "请正确填写营业执照号或统一社会信用代码");
jQuery.validator.addMethod("organizeNo", function(c, b) {
	var a =/^[A-Za-z0-9-]{1,10}$/;
	return this.optional(b) || (a.test(c))
}, "请正确填写组织机构代码证代码");
jQuery.validator.addMethod("taxId", function(c, b) {
	var a =/^[A-Za-z0-9]{1,15}$/;
	return this.optional(b) || (a.test(c))
}, "请正确填写税务登记证税字号");
jQuery.validator.addMethod("organizeTrustNo", function(c, b) {
	var a =/^[A-Za-z0-9]{1,18}$/ ;
	return this.optional(b) || (a.test(c))
}, "请正确填写机构信用代码证代码");
jQuery.validator.addMethod("accountLicenceNo", function(c, b) {
	var a =/^[A-Za-z0-9]{1,14}$/;
	return this.optional(b) || (a.test(c))
}, "请正确填写开户许可证核准号");

jQuery.validator.addMethod("iphone", function(c, b) {
	var a =/^(((13[0-9]{1})|(14[0-9]{1})|(17[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/;
	return this.optional(b) || (a.test(c))
}, "请正确填写您的手机号码");

jQuery.validator.addMethod("capitalAmount", function(c, b) {
	var a =/^[0-9]{1,7}$/;
	return this.optional(b) || (a.test(c))
}, "超过可输入注册金额");
